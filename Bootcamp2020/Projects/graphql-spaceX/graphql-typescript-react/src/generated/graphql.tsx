...
export type LaunchProfileQuery = { __typename?: 'Query', launch?: { __typename?: 'Launch', mission_name?: string | null | undefined, launch_year?: number | null | undefined, launch_success?: boolean | null | undefined } | null | undefined };

export type MissionInfoQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type MissionInfoQueryQuery = { __typename?: 'Query', launch?: { __typename?: 'Launch', mission_name?: string | null | undefined, launch_year?: number | null | undefined, launch_success?: boolean | null | undefined, details?: string | null | undefined, launch_site?: { __typename?: 'LaunchSite', site_name?: string | null | undefined } | null | undefined, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null | undefined, rocket_type?: string | null | undefined } | null | undefined } | null | undefined };
...
export const MissionInfoQueryDocument = gql`
...
/**
 * __useMissionInfoQueryQuery__
 *
 * To run a query within a React component, call `useMissionInfoQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useMissionInfoQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useMissionInfoQueryQuery(baseOptions: Apollo.QueryHookOptions<MissionInfoQueryQuery, MissionInfoQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MissionInfoQueryQuery, MissionInfoQueryQueryVariables>(MissionInfoQueryDocument, options);
      }
export function useMissionInfoQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionInfoQueryQuery, MissionInfoQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissionInfoQueryQuery, MissionInfoQueryQueryVariables>(MissionInfoQueryDocument, options);
        }
export type MissionInfoQueryQueryHookResult = ReturnType<typeof useMissionInfoQueryQuery>;
export type MissionInfoQueryLazyQueryHookResult = ReturnType<typeof useMissionInfoQueryLazyQuery>;
export type MissionInfoQueryQueryResult = Apollo.QueryResult<MissionInfoQueryQuery, MissionInfoQueryQueryVariables>;